...
function resizeReset() {
	...
	particles = [];
	for (let y = (((h - particleDistance) % particleDistance) + particleDistance) / 5; y < h; y += particleDistance) {
		for (let x = (((w - particleDistance) % particleDistance) + particleDistance) / 5; x < w; x += particleDistance) {
