;(function () {
  ...
  function changeSlideRight() {
    ...
    for (var i = 0; i < slides.length; i++) {
      if (slides[i].classList.contains("active")) {
        ...
        if (i < slides.length - 1) slides[++i].classList.add("active")
  ...
  var carouselElementsDisplayed = getComputedStyle(root).getPropertyValue(
  ...
  catalogNav.addEventListener("click", function (e) {
    ...
    var previousActiveBtn = document.querySelector(
  ...
  contactBtn.addEventListener("click", function () {
    ...
    burger.classList.toggle("hamburger_active")
    //body.classList.toggle('overflow')
    if (body.classList.contains("overflow")) body.classList.remove("overflow")
  })
  ...
  body.addEventListener("click", function (e) {
    ...
    if (
      ...
      e.target.classList.contains("popup__inner")
    ) {
  ...
  //GA 4 Contact Button event registration   >>>>>>>>>>>>>>>>>>>>>>*/
  ...
  //GA 4 Load More event registration   >>>>>>>>>>>>>>>>>>>>>>*/
  document.querySelector("#load-more").addEventListener("click", function () {
    gtag("event", "load_more_click", {
      event_category: "button",
      event_label: "Show more",
      element_id: "load-more", // Добавляем ID элемента
      value: 1,
    })
  })
  //GA 4 Load More event registration   />>>>>>>>>>>>>>>>>>>>>>*/
